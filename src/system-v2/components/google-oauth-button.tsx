...
import { useWarmUpBrowser } from '../session/use-warm-up-browser'
...
export function GoogleOAuthButton() {
  ...
  async function handleSignInWithGoogle() {
    try {
      ...
      // If this is a new sign-up, migration will be handled by the orchestrator
      if (isNewSignUp) {
        console.log('🆕 New Google sign-up detected')
      } else {
