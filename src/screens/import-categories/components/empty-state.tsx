...
export function EmptyState({ onPress }: ImportEmptyStateProps) {
  return (
    <View className="flex-1 items-center justify-center gap-6 px-8">
      ...
      <View className="items-center gap-2">
        <Text className="text-center text-xl font-bold">Import Categories</Text>
        <Text className="text-center text-base text-muted-foreground">
          Select a CSV file to import your categories.
        </Text>
      </View>
