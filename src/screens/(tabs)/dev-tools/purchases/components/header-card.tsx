      ...
      <CardContent className="gap-2.5 py-2.5">
        ...
        {appUserId && (
          <Pressable
            ...
            className="flex-row items-center gap-2 rounded-md bg-muted/50 px-2.5 py-1.5"
          >
            <Text
...
function Stat({
  ...
  return (
    <View className="flex-row items-center justify-between rounded-lg bg-muted/40 px-2.5 py-2">
