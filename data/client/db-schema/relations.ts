/*
================================================================================
RELATIONS SCHEMA - PowerSync SQLite Database Relationships
================================================================================
Purpose: Defines relationships between tables in the PowerSync SQLite database.
         These relations enable type-safe joins and queries in Drizzle ORM.

Note: Relations work identically for both PostgreSQL and SQLite in Drizzle,
      so the structure remains the same after converting table definitions.
================================================================================
*/
